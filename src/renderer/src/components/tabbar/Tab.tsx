...
const Tab: React.FC<TabProps> = ({ active }): React.ReactElement => {
  return (
    <div className={cn('h-full toolbar-tab-button pt-[4px] box-border')}>
      <div
        className={cn(
          'h-[36px] pb-[6px]! flex items-center py-[2px] px-[4px] box-border rounded-t-lg relative toolbar-btn-button-active',
          {
            'bg-white': active
          }
        )}
